...
namespace yayoCombat
{
    ...
    static public class PawnRenderer_override
    {
        ...
        static public bool animateEquip(PawnRenderer __instance, Pawn pawn, Vector3 rootLoc, float num, ThingWithComps thing, Stance_Busy stance_Busy, Vector3 offset, bool isSub = false)
        {
