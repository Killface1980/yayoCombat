...
namespace yayoCombat
{
    ...
    internal class patch_DrawEquipment
    {
        ...
        static bool Prefix(PawnRenderer __instance, Vector3 rootLoc, Pawn ___pawn)
        {
            ...
            {
                drawVanilla = !PawnRenderer_override.animateEquip(__instance, pawn, rootLoc + offsetMainHand, mainHandAngle, pawn.equipment.Primary, mainHandStance, new Vector3(-x, y, -z));
            }
            // 보조무기 // Offhand
            if (offHandEquip != null)
            {
                ...
                drawVanilla = !PawnRenderer_override.animateEquip(__instance, pawn, drawLoc, offHandAngle, offHandEquip, offHandStance, new Vector3(x, y, z), true) && drawVanilla;
            }
